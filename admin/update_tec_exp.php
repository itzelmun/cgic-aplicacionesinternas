...
$sql = "UPDATE ptcs SET tec_exp='$produccion' WHERE id=$id";

if(mysql_query($sql)){
		echo "Las técnicas de experimentación se han actualizado exitosamente";
		echo "<br /><br /><a href='index.php'> Regresar a principal... </a>";
	}else{
			echo "Hubo algún error al intentar actualizar las técnicas de experimentación, el error es: ".mysql_error();
			echo "<br /><br /><a href='index.php'> Regresar a principal... </a>";
		}
