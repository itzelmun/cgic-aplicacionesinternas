...
$sql = "UPDATE ptcs SET rec_tec='$produccion' WHERE id=$id";

if(mysql_query($sql)){
		echo "Los recursos técnicos se ha actualizado exitosamente";
		echo "<br /><br /><a href='index.php'> Regresar a principal... </a>";
	}else{
			echo "Hubo algún error al intentar actualizar los recursos técnicos, el error es: ".mysql_error();
			echo "<br /><br /><a href='index.php'> Regresar a principal... </a>";
		}
