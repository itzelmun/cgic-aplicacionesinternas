...
<div style="text-align: center;"><a href="publicaciones2021.htm"><span style="font-size: larger;">Consultar publicaciones 2021<br />
<br />
</span></a></div>
<div style="text-align: center;"><a href="publicaciones2020.htm"><span style="font-size: larger;">Consultar publicaciones 2020<br />
<br />
</span></a></div>
...
$consulta = mysql_query("SELECT titulo, autores, editorial FROM articulos WHERE (vigente=1 AND area='fisico' AND year=2022)");
...
<?
//$consulta = mysql_query("SELECT * FROM articulos ORDER BY id DESC");
$consulta = mysql_query("SELECT titulo, autores, editorial FROM articulos WHERE (vigente=1 AND area='biologia' AND year=2022)");
...
<?
//$consulta = mysql_query("SELECT * FROM articulos ORDER BY id DESC");
$consulta = mysql_query("SELECT titulo, autores, editorial FROM articulos WHERE (vigente=1 AND area='medicina' AND year=2022)");
...
<?
//$consulta = mysql_query("SELECT * FROM articulos ORDER BY id DESC");
$consulta = mysql_query("SELECT titulo, autores, editorial FROM articulos WHERE (vigente=1 AND area='humanidades' AND year=2022)");
...
<?
//$consulta = mysql_query("SELECT * FROM articulos ORDER BY id DESC");
$consulta = mysql_query("SELECT titulo, autores, editorial FROM articulos WHERE (vigente=1 AND area='sociales' AND year=2022)");
...
<?
//$consulta = mysql_query("SELECT * FROM articulos ORDER BY id DESC");
$consulta = mysql_query("SELECT titulo, autores, editorial FROM articulos WHERE (vigente=1 AND area='biotecnologia' AND year=2022)");
...
<?
//$consulta = mysql_query("SELECT * FROM articulos ORDER BY id DESC");
$consulta = mysql_query("SELECT titulo, autores, editorial FROM articulos WHERE (vigente=1 AND area='ingenieria' AND year=2022)");
