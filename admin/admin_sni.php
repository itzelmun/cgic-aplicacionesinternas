...
<table id="admin_sni">
	<tr id="titular">
        ...
        <td class="td_link">Dependencia</td>
		<td class="td_fecha">Nivel</td>
		<td class="td_acciones">Vigencia</td>
        <td class="td_udec">ID Scopus</td>
...
$consulta = mysql_query("SELECT * FROM sniinvestigadores ORDER BY apellido ASC");
 ...
 ?>
	<tr>
		<td><? echo $i; ?></td>
		<td class="td_descripcionjust"><? echo $grado.' '.$apellido.', '.$nombre; if($nombramiento != ""){?> <a href="<?=$nombramiento?>" target="_blank" style="text"> <img src="img/pdf.png" alt="PDF" width="20" height="25"></a><? } ?></td>
		<td><? switch($area){
												case "fisico":
        ...
        <td><? echo $nivel; ?></td>
        <td><? echo $vigenciaInicio." - ".$vigenciaFin; ?></td>
        <td><a href="<?= $perfilScopus ?>" target="_blank"><? echo $idScopus; ?></a></td>
        <td><? echo $mail; ?></td>
		<td> <a href="form_mod_sni.php?id=<?=$id ?>"> <img src="modificar.gif" alt='Modificar' title="Modificar" border='0' width='30' height='30' /> </a> <a href="eliminar_sni.php?id=<?=$id; ?>" onclick="return confirmar()"> <img src="borrar.gif" alt='Eliminar' title="Eliminar" border='0' width='30' height='30' /> </a></td>
