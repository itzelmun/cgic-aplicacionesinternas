...
if(isset($_POST['enviar']))
{
	...
	mysql_query("INSERT INTO sniinvestigadores (grado, nombre, apellido, area, nivelsni, vigencia, udec, mail, dependencia, perfilScopus, idScopus, comentarios) VALUES ('$grado', '$nombre', '$apellido', '$area', '$nivel', '$vigencia', '$udec', '$mail', '$dependencia', '$perfilScopus', '$idScopus', '$comentarios')")  or die(mysql_error()."<br/><br/><br/><center>ERROR: Ha ocurrido un error al INSERTAR EL REGISTRO en la base de datos</center>");
