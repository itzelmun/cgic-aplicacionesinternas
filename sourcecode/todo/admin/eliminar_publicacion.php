...
mysql_query("DELETE FROM publicaciones WHERE id='$id'") or die(mysql_error()."</br></br></br> Error: Ha ocurrido un error al tratar de eliminar la publicaci&oacute;n</center>");
