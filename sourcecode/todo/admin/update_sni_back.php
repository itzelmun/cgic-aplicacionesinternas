...
mysql_query("UPDATE sniinvestigadores SET grado='$grado', nombre='$nombre', area='$area', nivelsni='$nivel', vigencia='$vigencia', mail='$mail', udec='$udec' WHERE id='$id'")  or die(mysql_error()."<br/><br/><br/><center>ERROR: Ha ocurrido un error al intentar modificar el investigador.</center>");
