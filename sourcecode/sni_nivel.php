...
<div align="right">
    <p align="right">
        <strong><font color="#FD8431">Buscar Nivel</font></strong>
    ...
    while ($registros = mysqli_fetch_array($consulta)) {
        ...
        <tr>
            ...
            <td valign=top bordercolor="#F5F5F5">
                ...
                switch ($area) {
                    case "fisico":
                        echo "Físico Matemático y Ciencias de la Tierra";
                        break;

                    case "biologia":
                        echo "Biología y Química";
                        break;
                    ...
                    case "sociales":
                        echo "Sociales y Económico Administrativas";
                        break;

                    case "biotecnologia":
                        echo "Biotecnología y Ciencias Agropecuarias";
                        break;
