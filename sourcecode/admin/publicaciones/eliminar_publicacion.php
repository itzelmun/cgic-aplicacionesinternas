...
mysql_query("DELETE FROM articulos WHERE id='$id'") or die(mysql_error($conexion)."</br></br></br> Error: Ha ocurrido un error al tratar de eliminar el artículo</center>");

mysql_query("DELETE FROM sniarticulos WHERE idArticulo='$id'") or die(mysql_error($conexion)."</br></br></br> Error: Ha ocurrido un error al tratar de eliminar el artículo</center>");
