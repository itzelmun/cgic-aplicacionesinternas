...
<form id="noticias" name="noticias" method="post" action="captura_noticias.php">
  <fieldset id="usuario">
  <legend> Noticias: </legend>
  <ul>
  	<li>
  		<label>Texto Introductorio:<br /><span> (M&aacute;ximo 100 caracteres.)</span></label>
  	    <textarea id="int" name="introduccion" onfocus="this.value=''" onkeypress="return limita(event, 100)" cols="100" rows="5"> M&aacute;ximo 100 caracteres...</textarea>
  	</li>
	<li>
    	<label>Enlace directo: <br /><span> (El hiperv&iacute;nculo para leer la noticia completa.)</span></label>
		<textarea name="link" cols="100" rows="5"></textarea>
	</li>
  	<li>
  		<label>Fecha actual:</label>
  	    <input type="text" name="fecha" readonly="readonly" value="<? echo $fecha; ?>"  />
  	</li>
	</ul>
	</fieldset>
