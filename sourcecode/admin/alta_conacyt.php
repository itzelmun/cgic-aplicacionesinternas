...
if(isset($_POST['enviar']))
{
	...
	mysql_query("INSERT INTO conacytproyectos (fuente_financiamiento, nombre_responsable, concepto, año, monto) VALUES ('$fuente_financ', '$responsable', '$concepto', '$año', '$monto')")  or die(mysql_error()."<br/><br/><br/><center>ERROR: Ha ocurrido un error al INSERTAR EL REGISTRO en la base de datos</center>");
